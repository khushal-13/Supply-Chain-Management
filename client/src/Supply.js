...
function Supply() {
    ...
    const loadBlockchaindata = async () => {
        ...
        if (networkData) {
            ...
            window.alert('The smart contract is not deployed to the current network : medStage');
        }
    };
    ...
    const handlerSubmitRMSsupply = async (event) => {
        ...
        try {
            ...
            console.log(err);
            alert("An error occurred!!! : Supply - 1");
        }
    };
    ...
    const handlerSubmitManufacturing = async (event) => {
        ...
        try {
            ...
            console.log(err);
            alert("An error occurred!!! : Supply - 2");
        }
    };
    ...
    const handlerSubmitDistribute = async (event) => {
        ...
        try {
            ...
            console.log(err);
            alert("An error occurred!!! : Supply - 3");
        }
    };
    ...
    const handlerSubmitRetail = async (event) => {
        ...
        try {
            ...
            console.log(err);
            alert("An error occurred!!! : Supply - 4");
        }
    };
    ...
    const handlerSubmitSold = async (event) => {
        ...
        try {
            ...
            console.log(err);
            alert("An error occurred!!! : Supply - 5");
        }
    };
